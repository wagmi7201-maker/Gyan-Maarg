...
`,
    ...
    function generateLink(platform, query) {
      ...
      if (platform === "edX") return "https://www.edx.org/search?q=" + query;
      if (platform === "NPTEL") return "https://onlinecourses.nptel.ac.in/search?query=" + query;
    ...
    function generateImage(platform) {
      if (platform === "Udemy") return "https://img-c.udemycdn.com/course/480x270/1565838_e54e_16.jpg";
      if (platform === "Coursera") return "https://about.coursera.org/static/blueCoursera-646f855eae3b5e9f69d7.svg";
      if (platform === "edX") return "https://www.edx.org/images/logos/edx-logo-elm.svg";
      if (platform === "NPTEL") return "https://nptel.ac.in/assets/shared/logo-nptel.png";
      return "https://img-c.udemycdn.com/course/480x270/1565838_e54e_16.jpg";
    }
